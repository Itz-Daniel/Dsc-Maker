    ...
    client.on("ready", () => {
        ...
        var job = new CronJob('0 * * * * *', function () {
            ...
            switch(counter){
                ...
                case 2: {
                    try{client.user.setActivity(`botlist CyberneticDevelopment - SOON`, {type: "PLAYING"})}catch(e){console.log(String(e))}
                    counter++;
                }break;
                case 3: {
                ...
                case 5: {
                    try{client.user.setActivity(`Best Bots on Discord | Cybernetics Development`, {type: "PLAYING"})}catch(e){console.log(String(e))}
                    counter++;
                }break;
                case 6: {
                    try{client.user.setActivity(`Order Today! | Cybernetics Development`, {type: "PLAYING"})}catch(e){console.log(String(e))}
                    counter=0;
                }break;
                default: {
                    try{client.user.setActivity(`Free Bots | Cybernetics Development`, {type: "PLAYING"})}catch(e){console.log(String(e))}
                    counter = 0;
                    counter++;
                }break;
            }
